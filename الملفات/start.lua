...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " جابوا"
SudosS = {1965534755}
Sudos = {sudoid,1965534755}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
type = 'inline',
data = {
{{text = '⌔ 𝖲𝗈𝗎𝗋𝖼𝖾 𝗄𝖺𝖽𝗂',url="t.me/S_a_i_d_i"}},
}
}
...
{{text = '⌔ تغيير اسم البوت',data="namebot"},{text =(redis:get(bot_id..":namebot") or "جابوا"),data="delnamebot"}},
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/S_a_i_d_i&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "الساعه" then
bot.sendText(msg.chat_id,msg.id,"* ✧ الساعه الان : ( "..os.date("%I:%M%p").." )*","md",true)  
end
if text == "شسمك" or text == "سنو اسمك" then
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "جابوا"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "جابوا"),"اني لقميل "..(redis:get(bot_id..":namebot") or "جابوا"),(redis:get(bot_id..":namebot") or "جابوا").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "جابوا") then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserId_Info.id," *ꔹ━━━━━ꔹ𝐒𝐀𝐈𝐃𝐈ꔹ━━━━━ꔹ\n"..Banal.."\n"..silental.."\n"..rict..""..sent..""..an.."*").i,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserName,"*ꔹ━━━━━ꔹ𝐒𝐀𝐈𝐃𝐈ꔹ━━━━━ꔹ\n"..Banal.."\n"..silental.."\n"..rict..""..sent..""..an.."*").i,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender.user_id,"*ꔹ━━━━━ꔹ𝐒𝐀𝐈𝐃𝐈ꔹ━━━━━ꔹ\n"..Banal.."\n"..silental.."\n"..rict..""..sent..""..an.."*").i,"md",true)  
return false
end
...
local Text = '*𓄼• ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ sᴀɪᴅɪ •𓄹*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼• sᴏᴜʀᴄᴇ sᴀɪᴅɪ •𓄹',url="t.me/S_a_i_d_i"}
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/DEV_JABWA/88&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
----------------------------------------------------------------------------------------------------
if text == 'تفعيل' then
if msg.can_be_deleted_for_all_users == false then
